...
def GetPlayerName():
  ...
  while Valid == False:
    ...
    if len(PlayerName) >= 1:
      ...
      print("Sorry, a name must consist of at least one character.")
  print()
  return PlayerName
...
def DisplayRecentScores(RecentScores):
  ...
  print('Recent Scores: ')
  print()
  print("{0}{1:^10}".format("Name","Score"))
  print()  
  for Count in range(1, NO_OF_RECENT_SCORES + 1):
    print("{0}{1:^10}".format(RecentScores[Count].Name,RecentScores[Count].Score))
  print()
...
def UpdateRecentScores(RecentScores, Score):
  UpdateScore = input("Would you like your score to be saved to the resent scores board?: ")
  if UpdateScore[0].lower() == "y":    
    ...
    print()
    print("You've not been added to the leaderboard. Returning you to the main menu.")
